...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="communities.php?key=<?= urlencode(ADMIN_KEY) ?>" class="nav-item <?= ($current_page ?? '') === 'communities' ? 'active' : '' ?>">
      <svg class="nav-icon" fill="currentColor" viewBox="0 0 20 20">
    ...
    <a href="about.php?key=<?= urlencode(ADMIN_KEY) ?>" class="nav-item <?= ($current_page ?? '') === 'about' ? 'active' : '' ?>">
      <svg class="nav-icon" fill="currentColor" viewBox="0 0 20 20">
